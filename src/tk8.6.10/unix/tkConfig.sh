...
TK_LIBS='-lX11 -lXft -lfontconfig -lfreetype  -lfontconfig  -lpthread -ldl -lz  -lpthread '
...
# build directory.
TK_BUILD_LIB_SPEC='-L/usr/src/jcomeauictx/aports/main/tk/src/tk8.6.10/unix -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/usr/lib -ltk8.6'
...
# compiled.
TK_SRC_DIR='/usr/src/jcomeauictx/aports/main/tk/src/tk8.6.10'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/usr/src/jcomeauictx/aports/main/tk/src/tk8.6.10/unix -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/usr/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/usr/src/jcomeauictx/aports/main/tk/src/tk8.6.10/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/usr/lib/libtkstub8.6.a'
