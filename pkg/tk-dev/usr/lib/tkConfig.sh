...
# build directory.
TK_BUILD_LIB_SPEC='-L/usr/src/tk8.6.10/unix -ltk8.6'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/usr/src/tk8.6.10/unix -ltkstub8.6'
...
TK_BUILD_STUB_LIB_PATH='/usr/src/tk8.6.10/unix/libtkstub8.6.a'
